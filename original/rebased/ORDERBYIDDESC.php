<html> 
    <head> 
        ...
        <title> Références bibliographiques </title> <!-- nom de l'onglet-->
		...
		<br /> 
            <table> 
                <tr> <!-- table row = colonnes-->
                    ...
                    $query = 'SELECT id, salle, nom, gere, quantite, prix FROM bibliographie ORDER BY id DESC'; //AJOUT DE ORDER BY ID ASC
